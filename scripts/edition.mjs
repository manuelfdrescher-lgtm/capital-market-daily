...
3. Subagent news-curator: alle kapitalmarktrelevanten Meldungen seit der letzten Ausgabe sammeln und priorisieren (keine Obergrenze; für eine Vollausgabe mindestens genug für je 3 Artikel in JEDEM der Ressorts news, politik, unternehmen und makro — also insgesamt eher 13+ statt 7 bis 9 Artikel — bei dünnem Nachrichtenaufkommen pro Ressort auch kleinere echte Meldungen, Termine und Sekundärthemen aufnehmen statt einzelne Ressorts dünn zu lassen), inklusive deutscher Politik mit Marktbezug (Ressort politik, mindestens 3 Artikel, keine Ausnahmen); Fokus-Unternehmen vorschlagen.
...
11. Als editor die finale Ausgabe schreiben: Leitartikel und große Meldungen mit Artikelbild (image-Block). Bilder NIEMALS als SVG-Zeichnung: entweder ein vorhandenes fotorealistisches Bild aus public/images/ thematisch passend wiederverwenden, oder (falls claude-in-chrome verfügbar) ein neues fotorealistisches Foto über den ChatGPT-Bild-Workflow erzeugen; ist beides nicht möglich, image-Feld ganz weglassen. Nur lokale Dateien, nie SVG als Bild. JSON nach content/editions/${slug}.json (edition.number = ${nextNumber}, edition.date = "${date}", edition.slot = "${slot}", edition.isExample = false, edition.generatedAt = aktuelle ISO-Zeit, edition.dataAsOf = ehrliche Beschreibung des Datenstands, edition.schemaVersion = 2). Zusätzlich das neue Top-Level-Feld "lernecke" bauen (3 bis 5 Einträge, unabhängig von und zusätzlich zu den bestehenden kurzen learningNotes-Einzeilern, die unverändert bleiben): jeder Eintrag mit disziplin ("VWL" | "BWL" | "Politikwissenschaft"), modell (Name eines echten akademischen Modells/Konzepts, z. B. Phillips-Kurve, Prinzipal-Agent-Theorie, Median-Wähler-Theorem, Zinsparität, Efficient Market Hypothesis, Komparativer Kostenvorteil), erklaerung (die Theorie selbst von Grund auf für Laien erklärt, mehrere Sätze/ein kurzer Absatz, mind. 280 Zeichen) und anwendung (konkrete Anwendung dieses Modells auf ein Ereignis DIESER Ausgabe, mind. 140 Zeichen) — dabei die von macro-analyst und equity-analyst geflaggten Modelle/Zusammenhänge aufgreifen und wie ein Team aus VWL-, BWL- und Politikwissenschaftsprofessoren argumentieren, nicht nur einen Satz hinwerfen.
...
VERBINDLICHE REGELN:
- Umfang: ${isUpdate ? "Intraday-Update, Umfang wie gehabt" : "mindestens 3 Artikel in JEDEM der Ressorts news, politik, unternehmen und makro (also insgesamt eher 13+ statt 7 bis 9 Artikel), nicht nur die großen Top-Meldungen; Ressort titelseite bleibt genau 1 Leitartikel; Ressort politik ausdrücklich keine Ausnahme — niemals nur 1 Artikel"}. Jeder branchenMonitor-Eintrag hat ein istZustand-Feld (siehe Schritt 5) mit neuer, größerer Tiefe (ca. 5 bis 8 Sätze statt 2 bis 4, wo sinnvoll mit Bezug zu ökonomischen Modellen/Frameworks) — Einträge unter ca. 260 Zeichen scheitern ab schemaVersion 2 an der Validierung.
- Aktien-Tipps (stockPicks): kein sichtbares confidence-Label mehr im Feld/auf der Seite — die Meßlatte fürs Publizieren liegt stattdessen höher (nur Ideen mit echter, hoher Überzeugung erscheinen überhaupt). Stattdessen je Pick das neue Pflichtfeld marktEinordnung (Marktgröße/Nische/Warum-dieses-Unternehmen-Marktführer-ist, "McKinsey-Report"-Tiefe, mind. 200 Zeichen) sowie eine deutlich ausführlichere, echte Investment-These (thesis, mind. 400 Zeichen statt ein paar dünner Sätze). counterarguments (min. 2 echte Risiken) und catalysts (min. 1) bleiben exakt wie bisher Pflicht — Risikotransparenz bleibt, nur das Confidence-Label verschwindet.
